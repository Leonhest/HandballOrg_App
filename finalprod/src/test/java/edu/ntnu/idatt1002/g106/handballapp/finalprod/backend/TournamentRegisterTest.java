...
class TournamentRegisterTest {
    ...
    void addTournament_returns_false_when_tournamentID_is_the_similar(){
        ...
        Tournament tournament1 = new Tournament(1, "Oslo open",LocalDate.now(), LocalDate.now(), "Oslo", 3, 8, "RegionSor");
        Tournament tournament2 = new Tournament(1, "Oslo open",LocalDate.now(), LocalDate.now(),  "Oslo", 3, 8, "RegionOst");
