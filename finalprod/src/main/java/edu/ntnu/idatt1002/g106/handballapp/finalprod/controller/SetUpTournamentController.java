...
//        //tournamentLayoutInput.setOnAction(){}
//
//        //else if (tournamentLayoutInput.getSelectionModel().getSelectedIndex() == 0)
//
//    }
//
//    /**
...
//     */
//    private Image getImageByName(String imageName) {
//        return new Image("file:src/main/resources/edu/ntnu/idatt1002/g106/handballapp/mvp/TournamentPictures/" + imageName +  ".png");
//    }
//
//    @FXML
//    public void setImageOn() {
...
//                    layoutImageView.setImage(getImageByName("Layout3"));
//                    layoutText.setText(choosenFormat.substring(9));
//                    //layoutImageView.setImage(new Image("file:src/main/resources/edu/ntnu/idatt1002/g106/handballapp/mvp/TournamentPictures/Layout4.png"));
//                }
//                if(choosenFormat.equals("Layout 4: Max 32 teams")){
//                    layoutImageView.setImage(getImageByName("Layout4"));
//                    layoutText.setText(choosenFormat.substring(9));
